...
from src.repo.db import exceptions as exc
from src.types_app import _AS, TypeModel
from tests.testing_tools.base_testdata import Data
...
class BaseTest_CRUD:
    ...
    async def test__create(
        ...
        with pytest.raises(exc.NotNullViolationError, match="null value in column "):
        ...
        with pytest.raises(exc.AlreadyExists, match=Message.Error.ALREADY_EXISTS):
            await get_coro()
