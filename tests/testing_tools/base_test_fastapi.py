...
from src.types_app import _AS, _F, Any, TypeResponseJson
from tests.testing_tools.mixins import check_db, setup_db
    ...
    **path_params,
    ...
    return check_response(
        ...
        response=await getattr(async_client, get_http_method(http_method))(
            url=reverse(path_func=path_func, **path_params),
            params=query_params,
